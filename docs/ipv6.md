...
Generate server configuration with the udp6 or tcp6 protocol:
    ...
    docker run -v $OVPN_DATA:/etc/openvpn --rm gruz123/ovpn genconfig -u udp6://VPN.SERVERNAME.COM
    docker run -v $OVPN_DATA:/etc/openvpn --rm gruz123/ovpn genconfig -u tcp6://VPN.SERVERNAME.COM
